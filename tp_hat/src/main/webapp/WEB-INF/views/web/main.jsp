...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
	...
	<div class="carousel-inner" role="listbox">
		...
		<c:forEach items="${bannerImageList}" var="bannerImage" varStatus="b">
			<c:if test="${b.count==1}">
				<div class="carousel-item active" onclick="location.href='description?pno='+${bannerImage.pno}"
			...
			<c:if test="${b.count>1}">
				...
				<div class="carousel-item" onclick="Location.href = 'project/description?pno='+${bannerImage.pno}"
					style="background-image: url('${bannerImage.image}'); cursor: pointer;">
					<div class="carousel-caption d-none d-md-block">
						<h3>프로젝트 보러가기</h3>
					</div>
				...
				<c:forEach items="${closingTimeProjects}" var="ctp" varStatus="index">
					<div class="col-lg-4 col-sm-6 portfolio-item">
						<div class="card h-100">
							...
							<div >
								<a href="description?pno=${ctp.pno}">
								<img class="card-img-top" src="${ctp.image.image}"></a>
							</div>
							<div class="card-body">
								<h4 class="card-title">
							...
							<div>
								...
								<a><fmt:formatNumber value="${ctp.currentAmount}" groupingUsed="true"></fmt:formatNumber></a>
		...
		<c:forEach items="${popularProjects}" var="pp" varStatus="index">
			<div class="col-lg-4 col-sm-6 portfolio-item">
				<div class="card h-100">
					<!-- 해당 프로젝트 연결 / 아래 썸네일도 동일합니다 -->
					<div>
						<a href="description?pno=${pp.pno}"><img class="card-img-top" src="${pp.image.image}"></a>
					</div>
					<div class="card-body">
						<h4 class="card-title">
		...
		<c:forEach items="${lastestProjects}" var="lp" varStatus="index">
			<div class="col-lg-4 col-sm-6 portfolio-item">
				<div class="card h-100">
					<!-- 해당 프로젝트 연결 / 아래 썸네일도 동일합니다 -->
					<div>
						<a href="description?pno=${lp.pno}"><img class="card-img-top" src="${lp.image.image}"></a>
					</div>
					<div class="card-body">
						<h4 class="card-title">
					...
					<div class="progress">
						<a class="progress-bar progress-bar-striped" aria-valuenow="40" role="progressbar" aria-valuemin="0" aria-valuemax="100"
