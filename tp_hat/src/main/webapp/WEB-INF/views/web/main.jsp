...
<div>
	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox" style="margin-top: 3em;">
			<!-- 배너 이미지출력  -->
			<c:forEach items="${bannerImageList}" var="bannerImage"
				...
				<c:if test="${b.count==1}">
					<div class="carousel-item active" onclick="location.href='description?pno='+${bannerImage.pno}">
						<img class="d-block" src="${bannerImage.image}" style="cursor: pointer;">
		...
		<div class="content-category" style="transform: translateY(0px);">
			<!-- 전체보기 -->
			<div class="container" id="roundBtnCon">
