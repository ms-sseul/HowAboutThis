...
<nav class="navbar navbar-expand-lg navbar-light fixed-top">
	...
	<button class="navbar-toggler" type="button" data-toggle="collapse"
		data-target="#navbarMint" aria-controls="navbarMint"
	...
	<div class="collapse navbar-collapse" id="navbarMint">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item"><a class="nav-link"
				href="/controller/project/main">프로젝트 둘러보기</a></li>
			<li class="nav-item"><c:if test="${not empty loginId}">
					<a class="nav-link" href="/controller/project/create">프로젝트 만들기</a>
				</c:if></li>
			<li class="nav-item dropdown"><a class="nav-link"
				href="/controller/board/list">커뮤니티</a></li>
		</ul>

		<form class="form-inline my-2 my-lg-0" style="margin-right: 0.5em"
			action="/controller/project/search" method="get">
		...
		<c:if test="${not empty loginId}">
			<a href="/controller/user/profile"
				style="text-decoration: none; color: white;"> ${loginId}</a>님, 안녕하세요!
				...
				function() {
					...
					$('#btn-login').click(
							function() {
								...
								location = '/controller/user/login?url='
